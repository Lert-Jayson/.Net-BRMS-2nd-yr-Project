...
Public Class complist_report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BRMS_PROJECT.complist_report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcomplist_report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As complist_report = New complist_report
        rpt.Site = Me.Site
        Return rpt
    End Function
