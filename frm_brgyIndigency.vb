...
Public Class frm_brgyIndigency
    ...
    Private Sub frm_brgyIndigency_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        txt_cid.Hide()
        connectMe()
        ...
        Dim sid As Integer
        Dim cmd As New OdbcCommand("select ifnull(max(ind_id),0) from ind_tbl", con)
        ...
        Dim mycmd As New OdbcCommand("select * from ind_tbl", con)
    ...
    Private Sub btn_save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_save.Click
        ...
        Dim cmd1 As New OdbcCommand("select * from comp_tbl where lname = '" & lname & "'", con)
        dr1 = cmd1.ExecuteReader
        If dr1.HasRows Then
            MessageBox.Show("This person " & " " & lname & " has a bad record.", "Account info", MessageBoxButtons.OK, MessageBoxIcon.Information)
            btn_print.Enabled = False
            btn_save.Enabled = False
            txt_lname.Clear()
            txt_fname.Clear()
        ...
        Else
            ...
            Try
                ...
                Dim cmd As New OdbcCommand("select * from ind_tbl where fname = '" & fname & "' and lname = '" & lname & "'", con)
                ...
                Else
                    With mycmd
                        ...
                        .CommandText = "insert into ind_tbl values ('" & cid & "','" & lname & "','" & fname & "','" & age & "','" & civil & "','" & hnum & "','" & street & "','" & purp & "','" & dte & "','" & given & "','" & cap & "')"
                        .ExecuteNonQuery()
                    End With
                    MessageBox.Show("Barangay Indigency Information Added", "Add Account Info", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    End Sub
    Public Sub get_cid()
        Dim da As New OdbcDataAdapter("select max(ind_id) cid1 from ind_tbl", con)
        Dim ds As New System.Data.DataSet
        da.Fill(ds)
    ...
    Private Sub btn_print_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_print.Click
        Dim ind_rep As New indigency_report

        ind_rep.SetParameterValue("lname", txt_lname.Text)
        ind_rep.SetParameterValue("fname", txt_fname.Text)
        ind_rep.SetParameterValue("age", txt_age.Text)
        ind_rep.SetParameterValue("civil", txt_civil.Text)
        ind_rep.SetParameterValue("addr", txt_hnum.Text)
        ind_rep.SetParameterValue("street", txt_street.Text)
        ind_rep.SetParameterValue("purp", txt_purpose.Text)

        frm_printindigency.crysview_ind.ReportSource = ind_rep


        frm_printindigency.ShowDialog()
    End Sub

    Private Sub btn_search_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_search.Click
        frm_Residents.Show()
        frm_Residents.btn_selectIND.Show()
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Else
            ...
            Try
                ...
                Dim dr1 As OdbcDataReader
                Dim mycmd1 As New OdbcCommand("select * from ind_tbl where lname = '" & lname & "'", con)
                dr1 = mycmd1.ExecuteReader
                If dr1.HasRows Then
                    Dim mycmd2 As New OdbcCommand("select * from ind_tbl where lname = '" & lname & "'", con)
